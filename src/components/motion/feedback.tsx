  ...
  return (
    <Wrapper>
      <div className="flex items-center justify-center h-[500px] w-full">
        ...
        >
          <span className="h-full">Feedback</span>
        </Button>

        {open ? (
          <div
            className="absolute h-[192px] w-[364px] overflow-hidden bg-[#f5f6f7] p-1 outline-none shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_2px_2px_rgba(0,0,0,0.04)]"
            style={{ borderRadius: 12 }}
            ref={ref}
          >
            <span
              aria-hidden
              className="absolute top-[17px] left-[16px] text-sm text-[#63635d]"
            ...
            {formState === "success" ? (
              <div className="flex h-full flex-col items-center justify-center [&>svg]:-mt-1">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 32 32"
              ...
              >
                <textarea
                  ...
                  className="w-full h-[128px] resize-none rounded-t-lg p-3 text-sm outline-none placeholder:opacity-0"
                  required
                />
                <div className="relative flex items-center h-12 px-2.5">
                  <svg
